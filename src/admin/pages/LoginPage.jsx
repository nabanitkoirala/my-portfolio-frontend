          ...
          <div className="w-full text-[#32475c] tracking-[0.15px] ">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-4 ">
              <input
                ...
                className="bg-[#ffffff] py-[12px] px-[17px] border-[#32475c]  border-[1px] border-opacity-[22%] rounded-[4px] placeholder:opacity-[38%] text-inherit outline-[#32475c]f  outline-slate-300 "
              />
              {errors.email ? (
