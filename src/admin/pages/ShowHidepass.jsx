  ...
  return (
    <div className="flex justify-between border-[#32475c]  border-[1px] border-opacity-[22%] rounded-[4px] placeholder:opacity-[38%] text-inherit outline-slate-300">
      <input
        ...
        className="w-full py-[12px] pl-[17px] rounded-[4px] placeholder:opacity-[38%] text-inherit   outline-none bg-[#ffffff]"
        {...props}
      />
      <span
      ...
      >
        <img
          src={imgEye}
          alt=""
          className={`w-[24px] ${showPassword ? "text-[#696cff]" : "text-[red] opacity-[50%]"
            }`}
        />
      </span>
    </div>
